...
def get_articles_url_for_page(page_num):
    BASE_URL = 'https://dailysurge.com/page/'
...
def add_articles_for_page_to_database(page_num, max_number_to_add=10000):
    ...
    if not Publication.query.filter_by(name = 'dailysurge.com').first():
        Publication.create_publication(name = 'dailysurge.com')
